...
version:2.7.01 修正[致死boss5次]成就的对象，更改风滚草掉落机制，调整宝物宣告，为旺达完成死亡成就，大力士生命上限解锁，添加世界不同步季节，添加新能力[非等价交换],添加新彩蛋[开草福利]
version:2.7.02 增加了风滚草掉落物扩展接口,调整了合并部分类似掉落物,料理有加调料。新添加功能，为掉落物自动换皮肤。
version:2.7.05 修复状态表不能拆卸,关闭次元之客获取途径
version:2.7.06 旺达不能再吸血了，调整部分物品价值
