...
佩戴称号，各显风采
详情请看创意工坊说明
version:2.6.16 新增mod介绍网页按钮，对彩色护符使用逻辑进行调整，"查看"后,有,方可"传送"
version:2.6.18 旺达添加了专属技能，能够制作新的物品。修复彩色护符技能无效问题。
version:2.6.20 对风滚草进行了优化，新加幸运值高于20时对橙色以上的草有概率消耗幸运增加掉落物。
version:2.6.26 修复因添加旺达状态表"记录"动作无效问题
